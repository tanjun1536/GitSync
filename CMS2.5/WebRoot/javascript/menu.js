...
{
   if(document.getElementById('close').className=='close_a')
   {
   	document.getElementById('close').className='close_b'
   	document.getElementById('side').className='side_b'
   	document.getElementById('main').className='main_b'
	document.getElementById('menu').style.display='none';
	}else
	{
   	document.getElementById('close').className='close_a'
   	document.getElementById('side').className='side_a'
   	document.getElementById('main').className='main_a'
