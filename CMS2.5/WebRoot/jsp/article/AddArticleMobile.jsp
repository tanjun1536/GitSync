...
<html>
	...
	<body>
		...
		<form action="ArticleMobileAction!save.action" id="frm" method="post">
			...
			<div class="formdiv">
				...
				<ol>
					...
					<li>
						...
						<input id="article.section.id" name="article.section.id" type="hidden" class="easyui-combotree"  style="width: 200px;">
					</li>
					<li>
...
<!--					</li>-->
					...
					<li>
						<label for="article.titleImage" class="label">
							标题图片：<br/><font color="blue">(60px*60px) </font>
						</label>
						<c:choose>
							...
							<c:otherwise>
								<img src="${article.titleImage}" id="titleImagePreview" width="60" height="60" alt="标题图片" overflow: hidden; background-color: #FFFFFF; padding: 2px; border: 1px solid #CCC"/>
							</c:otherwise>
						</c:choose>
