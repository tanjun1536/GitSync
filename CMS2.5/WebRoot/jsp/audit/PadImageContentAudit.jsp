...
<html>
	<head>
		...
		<script type="text/javascript">
			...
			var urls = ["PadImageContentAuditAction!auditNext.action", "PadImageContentAuditAction!reject.action"];
			function onSubmit(){
		...
		<center>
			...
			<table cellpadding="0" cellspacing="0" border="0">
				...
				<tr>
					...
					<td>
						<input type="button" id="btnBack" onclick="fn.openURL('<%=basePath%>jsp/audit/PadImageContentAuditList.jsp')" value="返回">
					</td>
				</tr>
			</table>
			</form>
