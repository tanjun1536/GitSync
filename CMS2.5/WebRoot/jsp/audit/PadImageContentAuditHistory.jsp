...
<html>
	...
	$(function() {
		...
		//创建Grid
		window.jqGrid.createJqGridNoCheckbox("#gridTable", "#gridPager", "PadImageContentAuditAction!getAuditHistory.action?id=${param.id}", "json",headers, columns, 10,"审核历史","", undefined, "");
		//绑定新建按钮点击事件
