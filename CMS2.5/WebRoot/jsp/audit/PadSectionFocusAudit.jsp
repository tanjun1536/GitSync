...
<html>
	<meta name="generator" content="HTML Tidy, see www.w3.org">
		...
		<script type="text/javascript">
			var urls = ["PadSectionFocusAuditAction!auditNext.action", "PadSectionFocusAuditAction!reject.action"];
			function onSubmit(){
			...
			<div class="formdiv">
				<ol>
					...
					<li>
						...
						<input id="linkAddress" type="text" name="focus.linkAddress" value="${focus.linkAddress }" disabled="disabled" style="width: 200px" />
					</li>
					<li>
						<label for="" class="label">
							关联文章:
