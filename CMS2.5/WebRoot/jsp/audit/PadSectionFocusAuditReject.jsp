...
<html>
  ...
  <body>
    <center>
			<form name="form1" action="PadSectionFocusAuditAction!reject.action" method="post">
				<input name="id" type="hidden" value="${focus.id}">
				...
				<table cellpadding="0" cellspacing="0" border="0">
					...
					<tr>
						...
						<td>
							<input type="button" id="btnBack" onclick="fn.openURL('<%=basePath%>jsp/audit/PadSectionFocusAuditList.jsp?state=${state}')" value="返回">
						</td>
					</tr>
				</table>
			</form>
