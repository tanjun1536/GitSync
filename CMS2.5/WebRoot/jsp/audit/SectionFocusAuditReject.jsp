...
<html>
  ...
  <body>
    <center>
			<form name="form1" action="SectionFocusAuditAction!reject.action" method="post">
				...
				<table cellpadding="0" cellspacing="0" border="0">
					...
					<tr>
						...
						<td>
							<input type="button" id="btnBack" onclick="fn.openURL('<%=basePath%>jsp/audit/SectionFocusAuditList.jsp?state=${state}')" value="返回">
						</td>
					</tr>
				</table>
			</form>
