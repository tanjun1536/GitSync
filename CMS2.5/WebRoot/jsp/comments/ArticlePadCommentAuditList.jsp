...
<html>
	...
	$(function() {
		...
		//创建Grid
		window.jqGrid.createJqGridNoCheckBoxSeparateButton("#gridTable", "#gridPager", "ArticlePadCommentAction!getList.action", "json",headers, columns, 10,"文章列表", undefined,buttons);
	});
	...
	function audit(id)
	{
		fn.openURL('<%=basePath%>jsp/comments/ArticlePadCommentList.jsp?id=' + id);
	}
</script>
