...
<html>
	...
	<body>
		...
		<div id=tabs>
			...
			<div id=tabs-1>
			<iframe frameborder="0" width="99%" height="1610px" src="jsp/distribute/SectionFocusPadDistributeBefore.jsp"></iframe>
			</div>
			<div id=tabs-2>
			<iframe frameborder="0" width="99%" height="1610px" src="jsp/distribute/SectionFocusPadDistributeAfter.jsp"></iframe>
			</div>
		</div>
	</body>
</html>
