...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="javascript/jquery-easyui-1.2.5/themes/default/tree.css" />
		<!--弹出窗口-->
	...
	<body>
		...
		<div class="Imgdiv">
			...
			<div class="ImgdivR">
				<iframe id="tabs" src="jsp/distribute/SectionFocusPadDistributeTabs.jsp" height="1610px" frameborder="0" style="width: 100%;"></iframe>
			</div>
		</div>
	</body>
</html>
