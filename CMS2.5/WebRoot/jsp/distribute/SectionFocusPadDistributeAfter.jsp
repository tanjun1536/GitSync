		...
		<script type="text/javascript">
			...
			$("#section").tree({
				...
				onClick:function(node){
					jqGrid.reLoad('#gridTable','SectionFocusPadDistributeAction!getSectionFocusPadHasDistribute.action?section='+node.id);
			...
			window.jqGrid.createJqGridSeparateButton("#gridTable", "#gridPager", "", "json",headers, columns, 10,"手机焦点已发布列表", undefined,buttons);
		});
