...
<html>
	<head>
		...
		<script src="jsp/img/sectionTree.js" type="text/javascript"></script>
		<script type="text/javascript">
	$(function() {
		SectionTree.init("tt2");
		//$("#ImgContent").height($("#tt2").height());
	});
</script>
	</head>
	<body>
		...
		<div class="Imgdiv">
			...
			<div class="ImgdivR">
				<iframe id="ImgContent" name="ImgContent" src="" height ="1610px" frameborder="0" style="width: 100%;"></iframe>
			</div>
		</div>
