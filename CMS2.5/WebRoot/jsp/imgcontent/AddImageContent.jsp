...
<html>
	...
	<body>
		<center>
			<form name="form1" action="ImageContentAction!save.action" method="post" onsubmit="return onSubmit()">
				<table cellpadding="0" cellspacing="0" border="0">
					...
					<tr>
						...
						<td>
							<input type="text" name="imgContent.title" style="width: 200px" required="true"/>
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							<input type="text" name="imgContent.subTitle" style="width: 200px" required="true"/>
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							<input type="text" name="imgContent.keywords" style="width: 200px" required="true"/>
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							<input type="text" name="imgContent.source" style="width: 200px" required="true"/>
						</td>
					</tr>
					<tr>
						<td>
					...
					<tr>
						...
						<td>
							<textarea name="imgContent.summary" style="width: 200px" required="true"></textarea>
						</td>
					</tr>
					<tr>
						<td>
						...
						<td>
							<input type="button" id="btnBack" onclick="fn.openURL('<%=basePath%>jsp/imgcontent/ImageContentList.jsp')" value="返回">
						</td>
					</tr>
				</table>
			</form>
