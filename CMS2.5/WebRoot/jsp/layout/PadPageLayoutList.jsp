...
<html>
	<head>
		...
		var section=null;
			$(function() {
				...
				onClick:function(node){
					 section=node.id;
					 $("#tabs").each(function(index) {try { this.contentWindow.refreshList(section); } catch (e) { } });
				},
				//右键鼠标事件
		...
		fn.openURL('<%=basePath%>PadPageLayoutAction!add.action?section='+section);
	}
</script>
	</head>
	<body>
		...
		<div class="Imgdiv">
			...
			<div class="ImgdivR">
				<iframe id="tabs" src="jsp/layout/PadPageLayoutListTabs.jsp" height ="1610px" frameborder="0" style="width: 100%;"></iframe>
			</div>
		</div>
	</body>
</html>
