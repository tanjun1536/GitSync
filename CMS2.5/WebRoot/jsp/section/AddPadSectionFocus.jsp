			...
			$(function(){
				$("#section\\.parent\\.id").combotree({
					onSelect:function(node){
						...
						//isLeaf = $('#section\\.parent\\.id').combotree().tree('isLeaf', node.target);
					}
				});
			})
...
//				if(selectedSection.id != 1 && /*isLeaf*/ selectedSection.target.innerHTML.indexOf("tree-file") == -1){
...
//				}
	...
	<body>
		...
		<form name="form1" enctype="multipart/form-data" action="PadSectionFocusAction!save.action" method="post" onsubmit="return onSubmit()">
			<div class="formdiv">
