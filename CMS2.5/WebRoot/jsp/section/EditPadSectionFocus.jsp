			...
			<div class="formdiv">
				...
				<ol>
					...
					<li>
						...
						<input id="title" type="text" name="focus.title" style="width: 200px" value="${focus.title }" required="true" />
					</li>
					<li>
						<label class="label">
							当前状态:
					...
					<li>
						...
						<input id="linkAddress" type="text" name="focus.linkAddress" style="width: 200px" value="${focus.linkAddress }" />
					</li>
<!--					<li>-->
<!--						<label class="label">-->
<!--							关联文章:-->
...
<!--					<li id="art" style="display: none;">-->
					<li id="art">
						...
						<input id="focus.article.id" name="focus.article.id" value="${focus.article.id}"  type="hidden" />
						<input id="artTitle" type="text" value="${focus.article.title}" readonly="readonly" />
					...
					<li id="con" style="display: block;">
						...
						<textarea name="focus.content" onpropertychange="if(value.length>200) value=value.substr(0,200)" rows="8" style="width: 570px; font-size: 14px" placeholder="请编辑正文内容">${focus.content }</textarea>
					</li>
				</ol>
