...
//				}
	...
	<body>
		...
		<form name="form1" enctype="multipart/form-data" action="SectionFocusAction!update.action" method="post" onsubmit="return onSubmit()">
			...
			<div class="formdiv">
				...
				<ol>
					<li>
						...
						<input id="section.parent.id" name="focus.section.id" disabled="disabled" class="easyui-combotree" url="SectionAction!getSectionTreeJSON.action" style="width: 202px;" />
					</li>
					<li>
						<label class="label">
							焦点标题:
					...
					<li>
						...
						<input id="linkAddress" disabled="disabled" type="text" name="focus.linkAddress" value="${focus.linkAddress }" style="width: 200px" />
					</li>
<!--					<li>-->
<!--						<label class="label">-->
<!--							关联文章:-->
...
<!--					<li id="art" style="display: none;">-->
					...
					<li id="con" style="display: block;">
						...
						<textarea disabled="disabled" name="focus.content" onpropertychange="if(value.length>200) value=value.substr(0,200)" rows="8" style="width: 570px; font-size: 14px" placeholder="请编辑正文内容">${focus.content }</textarea>
					</li>
				</ol>
