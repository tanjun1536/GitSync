...
import com.gang.service.section.PadSectionFocusService;

public class PadSectionFocusAction extends DefaultAction {

	private static final long serialVersionUID = 1L;
	/**
	 * 数据库操作服务
	 */
	private PadSectionFocusService service;
	...
	public String add() throws Exception {
		...
		addAttribute("states", service.getStates(State.TYPE_SECTION_PAD));
		return ADD;
	}
	...
	public String edit() throws Exception {
		...
		getRequest().setAttribute("as", as);
		addAttribute("states", service.getStates(State.TYPE_SECTION_PAD));
		focus = (PadSectionFocus)service.get(PadSectionFocus.class, focus.getId());
	...
	public void getList() throws Exception {
		...
		gr.setOrderType("ASC");
		String hqlD = "FROM PadSectionFocus WHERE 1=1 ";
		String hqlC = "SELECT COUNT(*) FROM PadSectionFocus WHERE 1=1 ";
		String where = getWhere();
		gr.setCsql(hqlC + where);
		gr.setDsql(hqlD + where);
		gr.setHsql(true);
		gr.addCglibProperty("getSection", new AddCglibPropertyHandler(){@Override
...
//			// 标题图片
//			String focusImageURL = FileHelper.saveFiles(focusImage, uploadDir, saveDir);
...
//		}
	...
	public void setService(PadSectionFocusService service) {
