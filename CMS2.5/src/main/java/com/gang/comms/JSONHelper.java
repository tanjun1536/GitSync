...
public class JSONHelper {
	...
	{
		String json=SerializeWithNeedAnnotationNone(obj);
		return json;
	}
	public static String SerializeWithNeedAnnotationNone(Object obj)
	{
		Gson gs=new GsonBuilder().setDateFormat("yyyy-MM-dd HH:mm:ss").excludeFieldsWithoutExposeAnnotation().create();   
