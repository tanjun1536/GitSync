		...
		<li><a href="__APP__/Favorite">我的最愛</a>  </li>
			...
			<div class="mainInfo">
				...
				<table width="695" border="0" cellpadding="0" cellspacing="0" class="mailList">
					<tr>
						<th width="100" scope="col">寄件者</th>
						<th width="26" scope="col">&nbsp;</th>
						<th width="478" scope="col">主旨</th>
						<th width="91" scope="col">寄件日期</th>
					</tr>
					...
					<td><a href="__URL__/view?id=<?php echo ($item["id"]); ?><?php if($item["isread"] == 0 ): ?>&noread=1<?php endif; ?>"><?php if($item["isread"] == 0 ): ?><strong><?php echo ($item["title"]); ?>(未讀)</strong><?php else: ?><?php echo ($item["title"]); ?>(已讀)<?php endif; ?></a></td>
