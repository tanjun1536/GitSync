				...
				<form id="form1" name="form1" method="post"
					...
					<table width="695" border="0" cellpadding="0" cellspacing="1"
						...
						<tr>
							...
							<td><input type="text" name="spricecode" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<input type="hidden" id="requestunitid" name="requestunitid" value="<?php echo ($depart["id"]); ?>"  />
							<input type="hidden" id="requestunitname" name="requestunitname" value="<?php echo ($depart["name"]); ?>"  />
					...
					<input type="hidden" id="totalprice" name="totalprice" />
							...
							發票金額合計：<span id="stotal"></span><br /> 稅金(5%)：<span id="stax"></span><br /> 發票金額總計：<span id="stotalprice"></span><br />
						</p>
					</div>
					<div align="center">
