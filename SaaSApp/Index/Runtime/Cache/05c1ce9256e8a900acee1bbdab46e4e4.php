...
<?php if(is_array($TopMenu)): $i = 0; $__LIST__ = $TopMenu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): ++$i;$mod = ($i % 2 )?><?php if(empty($item["children"])): ?><li><a href="<?php echo ($item["link"]); ?>"><?php echo ($item["name"]); ?></a></li>
		...
		<li><a href="__APP__/Favorite">我的最愛</a>  </li>
			...
			<div class="mainInfo">
				<form action="__URL__/addProductBigType" method="post" enctype="multipart/form-data" name="form1" id="form1">
					...
					<div class="topic2">商品大類別</div>
<!-- 					<table width="695" border="0" align="center" cellpadding="0" cellspacing="1" class="tabThSide"> -->
<!-- 						<tr> -->
<!-- 							<th width="134" scope="row">新增 / 修改大類別</th> -->
<!-- 							<td width="558"><input type="text" name="name" value="<?php echo ($mt["name"]); ?>" /> <input type="submit" name="Submit" value="確定" /></td> -->
<!-- 						</tr> -->
<!-- 					</table> -->
				</form>
				<form id="form2" name="form2" method="post" action="">
					...
					<table width="695" border="0" cellpadding="0" cellspacing="0" class="tab_thtop">
						...
						<td align="center"><a href="__URL__/productMainType?bt=<?php echo ($item["id"]); ?>"><?php echo ($item["s_name"]); ?></a></td>
						<td align="center"><a href="__URL__/updateProductBigType?id=<?php echo ($item["id"]); ?>">修改</a> | <a onclick="return confirm('是否刪除該數據?')" href="__URL__/deleteProductBigType?id=<?php echo ($item["id"]); ?>">刪除</a></td>
