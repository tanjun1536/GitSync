...
<?php if(is_array($TopMenu)): $i = 0; $__LIST__ = $TopMenu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): ++$i;$mod = ($i % 2 )?><?php if(empty($item["children"])): ?><li><a href="<?php echo ($item["link"]); ?>"><?php echo ($item["name"]); ?></a></li>
		...
		<li><a href="__APP__/Favorite">我的最愛</a>  </li>
			...
			<div class="mainInfo">
					...
					<table width="695" border="0" align="center" cellpadding="0" cellspacing="1" class="tabThSide">
						<tr>
							...
							<td width="250"><select name="qtype">
									...
									<?php if(is_array($types)): $i = 0; $__LIST__ = $types;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): ++$i;$mod = ($i % 2 )?><?php if($item["id"] == $type): ?><option value="<?php echo ($item["id"]); ?>" selected="selected"><?php echo ($item["name"]); ?></option>
									<?php else: ?>
							...
							<td width="240"><input type="text" name="qname" value="<?php echo ($mname); ?>" /></td>
						</tr>
						<tr>
							<th scope="row">&nbsp;</th>
				...
				<div class="mailNav">
				<?php if(check_power('新增廠商',$ext) == 1): ?><a href="__URL__/addManufacturersPage">新增廠商</a><?php endif; ?>
				</div>
				<table width="695" border="0" cellpadding="0" cellspacing="0" class="tab_thtop">
					...
					<td align="center"><?php echo ($item["mprov"]); ?><?php echo ($item["mcity"]); ?><?php echo ($item["maddress"]); ?></td>
					<td align="center"><?php echo ($item["mlinkphone"]); ?></td>
					<td align="center"><?php echo ($item["mlinker1"]); ?></td>
					<td align="center">
					<?php if(check_power('修改廠商',$ext) == 1): ?><a href="__URL__/updateManufacturers?id=<?php echo ($item["id"]); ?>">修改</a><?php endif; ?>
							<?php if(check_power('刪除廠商',$ext) == 1): ?><a href="__URL__/deleteManufacturers?id=<?php echo ($item["id"]); ?>" onclick="return confirm('是否刪除該數據?')">刪除</a><?php endif; ?>
