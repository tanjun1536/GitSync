		...
		<li><a href="__APP__/Favorite">我的最愛</a>  </li>
			...
			<div class="mainInfo">
				<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
					<div class="mailNav">
						<?php if(check_power('新增專案',$ext) == 1): ?><a href="__URL__/add">新增專案</a><?php endif; ?>
						專案名稱 <input type="text" name="key" /> <input type="submit" name="Submit" value="搜尋" />
					</div>
				</form>
				<form action="__URL__/delete" method="post" enctype="multipart/form-data" name="form1" onsubmit="return confirm('是否確認刪除選擇的數據?')" id="form1">
					<table width="695" border="0" cellpadding="0" cellspacing="0" class="tab_thtop">
						<tr>
							<th width="28" scope="col">&nbsp;</th>
							<th width="371" scope="col">專案名稱</th>
							<th width="98" scope="col">專案起始日</th>
							<th width="98" scope="col">預定結束日</th>
							<th width="98" scope="col">實際結束日</th>
						</tr>
						...
						<td><a href="__URL__/content?case=<?php echo ($item["id"]); ?>"><?php echo ($item["name"]); ?></a></td>
						<td align="center"><?php echo (date('Y/m/d',strtotime($item["casestartdate"]))); ?></td>
						<td align="center"><?php echo (date('Y/m/d',strtotime($item["caseevaluateenddate"]))); ?></td>
						<td align="center"><?php if(($item["casereallyenddate"])  !=  "0000-00-00 00:00:00"): ?><?php echo (date('Y/m/d',strtotime($item["casereallyenddate"]))); ?><?php endif; ?></td>
						</tr><?php endforeach; endif; else: echo "" ;endif; ?>
					</table>
					<div style="margin-top: 10px">
						<?php if(check_power('刪除專案',$ext) == 1): ?><input type="submit" name="Submit2" value="刪除" /><?php endif; ?>
					</div>
				</form>
			</div>
		</div>
