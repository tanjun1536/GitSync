			...
			<div class="mainInfo">
				...
				<form action="__URL__/updateProfile" method="post" enctype="multipart/form-data" name="form1" id="form1">
					<table width="695" border="0" align="center" cellpadding="0" cellspacing="1" class="tabThSide">
						...
						<tr>
							<th scope="row">帳號</th>
							<td><?php echo ($user["username"]); ?><input type="hidden" name="username" id="username" value="<?php echo ($user["username"]); ?>" /></td>
						</tr>
						<tr>
							<th scope="row">密碼</th>
						...
						<tr>
							...
							<td width="592"><?php echo ($user["name"]); ?><input type="hidden" name="name" value="<?php echo ($user["name"]); ?>" /></td>
						</tr>
						<tr>
							<th scope="row">籍貫</th>
						...
						<tr>
							...
							<td><select name="province" id="province">
									...
									<option value="請選擇">請選擇</option>
							</select> <input type="text" name="address" style="width: 300px" value="<?php echo ($user["address"]); ?>" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="text" class="Wdate" onFocus="WdatePicker()" value="<?php echo (date('Y-m-d',strtotime($user["onduty"]))); ?>" name="onduty" /></td>
						</tr>
						<tr>
							<th scope="row">所屬部門</th>
							<td><?php echo ($departName); ?> <input type="hidden" name="depart" id="depart" value="<?php echo ($user["depart"]); ?>" /> <input type="hidden" name="team" id="team" value="<?php echo ($user["team"]); ?>" />
							</td>
						</tr>
						<tr>
							<th scope="row">離職日期</th>
							<td><input type="text" class="Wdate" onFocus="WdatePicker()" value="<?php echo (date('Y-m-d',strtotime($user["offduty"]))); ?>" name="offduty" /></td>
						</tr>
						<tr>
							<th scope="row">經歷</th>
							<td><table width="580" border="0" cellpadding="0" cellspacing="0" id="experience">
									...
									<?php if(is_array($user["experiences"])): $i = 0; $__LIST__ = $user["experiences"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$exp): ++$i;$mod = ($i % 2 )?><tr>
										<td><?php echo ($exp["companyname"]); ?></td>
						...
						<tr>
							<th scope="row">兵役</th>
							<td><?php switch($user["army"]): ?><?php case "役畢":  ?><input name="army" checked="checked" type="radio" value="役畢" /> 役畢 <input name="army" type="radio" value="未服役" /> 未服役 <input name="army" type="radio" value="免役" />免役<?php break;?> <?php case "未服役":  ?><input name="army" type="radio" value="役畢" /> 役畢 <input name="army" checked="checked" type="radio" value="未服役" /> 未服役 <input name="army" type="radio" value="免役" />免役<?php break;?> <?php case "免役":  ?><input name="army" type="radio" value="役畢" /> 役畢 <input name="army" type="radio" value="未服役" /> 未服役 <input checked="checked" name="army" type="radio" value="免役" />免役<?php break;?><?php endswitch;?> ， 說明： <input type="text" name="armyremark" value="<?php echo ($user["armyremark"]); ?>" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="text" name="linkman" value="<?php echo ($user["linkman"]); ?>" /> 關係： <input type="text" name="linkrelation" value="<?php echo ($user["linkrelation"]); ?>" /></td>
						</tr>
						<?php if(!empty($canedit)): ?><tr>
							<th scope="row">&nbsp;</th>
