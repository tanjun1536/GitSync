  ...
  <?php echo $_SESSION["caseName"];?>
			...
			<div class="mainInfo">
				...
				<form id="form1" name="form1" method="post" action="__URL__/insertWorkShift?case=<?php echo $_SESSION["case"];?>" onsubmit="return check();">
					<input type="hidden" name="case" value="<?php echo ($move["case"]); ?>" />
					<input type="hidden" name="id" value="<?php echo ($move["id"]); ?>" />
					 <input type="hidden" name="keyusername" value="<?php echo ($move["keyusername"]); ?>" /> <input type="hidden" name="keyuserid" value="<?php echo ($move["keyuserid"]); ?>" /> <input type="hidden" name="movetime" value="<?php echo ($move["movetime"]); ?>" />
					<table width="695" border="0" cellpadding="0" cellspacing="1" class="tabThSide">
						<tr>
							<th width="95" scope="row">調班單號</th>
							<td width="249"><input type="text" name="movecode" value="<?php echo ($move["movecode"]); ?>" /></td>
							<th width="102" scope="row">KEY單人</th>
							<td width="244"><?php echo ($move["keyusername"]); ?></td>
						</tr>
						<tr>
							<th scope="row">調班月份</th>
							<td>西元 <input type="text" name="moveyear" style="width: 70px" value="<?php echo ($move["moveyear"]); ?>" /> 年 <select name="movemonth">
					...
					<table width="695" border="0" cellpadding="0" cellspacing="0" class="tab_thtop" id="tabDetail">
						...
						<td align="center"><?php echo ($item["username"]); ?><input type="hidden" value="<?php echo ($item["username"]); ?>,<?php echo ($item["movetime"]); ?>,<?php echo ($item["oldworktype"]); ?>,<?php echo ($item["newworktype"]); ?>" name="detail[]"></td>
