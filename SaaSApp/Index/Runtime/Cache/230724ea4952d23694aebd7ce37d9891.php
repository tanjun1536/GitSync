...
<?php if(is_array($TopMenu)): $i = 0; $__LIST__ = $TopMenu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): ++$i;$mod = ($i % 2 )?><?php if(empty($item["children"])): ?><li><a href="<?php echo ($item["link"]); ?>"><?php echo ($item["name"]); ?></a></li>
			...
			<div class="mainInfo">
				<div class="topic2">顯示案件名稱</div>
				<div class="mailNav">
					<a href="__URL__/acceptUserList?accept=<?php echo $_GET["accept"];?>">點交驗收人員列表</a><a
						href="__URL__/acceptCheckAdd?accept=<?php echo $_GET["accept"];?>">新增點交紀錄</a>
				</div>
				<table width="695" border="0" cellpadding="0" cellspacing="0"
					class="tab_thtop">
					<tr>
						<th width="90" scope="col">日期時間</th>
						<th width="248" scope="col">點交工程名稱</th>
						<th width="234" scope="col">地點</th>
						<th width="68" scope="col">點交類型</th>
						<th width="73" scope="col">操作</th>
					</tr>
					...
					<td align="center"><?php echo (formatDate($item["acceptdate"])); ?></td>
					<td align="center"><?php echo ($item["acceptproject"]); ?></td>
					<td align="center"><?php echo ($item["acceptaddress"]); ?></td>
					<td align="center"><?php echo ($item["accepttype"]); ?></td>
					<td align="center"><a href="__URL__/acceptCheckEdit?accept=<?php echo $_GET["accept"];?>&id=<?php echo ($item["id"]); ?>">修改</a><a href="__URL__/acceptCheckDelete?accept=<?php echo $_GET["accept"];?>&id=<?php echo ($item["id"]); ?>">刪除</a></td>
