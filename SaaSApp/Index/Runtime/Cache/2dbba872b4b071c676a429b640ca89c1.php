...
<?php if(is_array($TopMenu)): $i = 0; $__LIST__ = $TopMenu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): ++$i;$mod = ($i % 2 )?><?php if(empty($item["children"])): ?><li><a href="<?php echo ($item["link"]); ?>"><?php echo ($item["name"]); ?></a></li>
		...
		<li><a href="__APP__/Favorite">我的最愛</a>  </li>
			...
			<div class="mainInfo">
				...
				<div class="mailNav">
				<?php if(check_power('新增採購單',$ext) == 1): ?><a href="__URL__/addPurchasePage">新增採購單</a><?php endif; ?>
				...
				<form id="form1" onsubmit="return delAwoke()" name="form1" method="post" action="__URL__/deletePurchase">
					<table width="695" border="0" cellpadding="0" cellspacing="0" class="tab_thtop">
						...
						<td align="center"><a href="__URL__/purchaseView?id=<?php echo ($item["id"]); ?>"><?php echo ($item["purchasecode"]); ?></a></td>
						<td><?php echo ($item["mname"]); ?></td>
						<td align="center"><?php echo (date('Y/m/d',strtotime($item["purchasedate"]))); ?></td>
						<td align="center"><?php echo ($item["totalmoney"]); ?></td>
						<td align="center"><?php echo ($item["purchasestate"]); ?></td>
						<td align="center"><?php if($item["purchasestate"] == '新進單'): ?><a href="__URL__/purchaseCheckPage?id=<?php echo ($item["id"]); ?>">審核</a><?php endif; ?></td>
						</tr><?php endforeach; endif; else: echo "" ;endif; ?>
					</table>
					<div style="margin-top: 10px">
					<?php if(check_power('刪除採購單',$ext) == 1): ?><input type="submit" name="Submit" value="刪除" /><?php endif; ?>
