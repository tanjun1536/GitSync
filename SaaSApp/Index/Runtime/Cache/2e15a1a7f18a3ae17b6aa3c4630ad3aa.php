...
<?php if(is_array($TopMenu)): $i = 0; $__LIST__ = $TopMenu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): ++$i;$mod = ($i % 2 )?><?php if(empty($item["children"])): ?><li><a href="<?php echo ($item["link"]); ?>"><?php echo ($item["name"]); ?></a></li>
			...
			<div class="mainInfo">
				<div class="mailNav">
					<a href="__URL__/acceptUserAdd?accept=<?php echo $_GET["accept"];?>">新增人員</a>
				</div>
				<table width="695" border="0" cellpadding="0" cellspacing="0"
					class="tab_thtop">
					<tr>
						<th width="123" scope="col">姓名</th>
						<th width="102" scope="col">身份證</th>
						<th width="113" scope="col">聯絡電話</th>
						<th width="309" scope="col">EMAIL</th>
					...
					<td align="center"><?php echo ($item["card"]); ?></td>
					<td align="center"><?php echo ($item["phone"]); ?></td>
					<td align="center"><?php echo ($item["email"]); ?></td>
					<td align="center"><a onclick="return confirm('是否要刪除選擇的數據?')" href="__URL__/acceptUserDelete?id=<?php echo ($item["id"]); ?>&accept=<?php echo $_GET["accept"];?>">刪除</a></td>
