			...
			<div class="mainInfo">
				<div style="margin-bottom: 10px">
					<form id="form1" name="form1" method="post" action="">
						...
						</strong><strong>單位： <select name="team" id="team" disabled="disabled">
								<option value="">所有單位</option>
						</select> 日期：
						</strong> <input type="text" name="sdate" class="Wdate" value="<?php echo ($sdate); ?>" onfocus="WdatePicker()" style="width: 100px" /> ~ <input type="text" value="<?php echo ($edate); ?>" class="Wdate" onfocus="WdatePicker()"  name="edate" style="width: 100px" /> 
						<input type="button" name="Submit" onclick="$('#form1').attr('action','__URL__/unit').submit();" value="搜尋" />
						<input type="button" name="Submit" onclick="$('#form1').attr('action','__URL__/exportCheckUnit').submit();" value="導出" />
					</form>
				</div>
...
<!-- 					<td align="center"><?php echo (date('Y/m/d',strtotime($item["date"]))); ?> (<?php echo (getWeek($item["date"])); ?>)</td> -->
					...
					<td align="center"><a href="__URL__/viewperson?pid=<?php echo ($item["userid"]); ?>"><?php echo ($item["name"]); ?>(<?php echo ($item["ucode"]); ?>)</a></td>
					<td align="center"><?php echo (formatDate($item["ontime"],'Y/m/d H:i:s')); ?></td>
					<td align="center"><?php echo (formatDate($item["downtime"],'Y/m/d H:i:s')); ?></td>
					<td align="center"><?php echo (formatDate($item["difftime"],'H小时i分s秒')); ?></td>
