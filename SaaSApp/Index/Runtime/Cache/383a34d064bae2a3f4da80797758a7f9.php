			...
			<div class="mainInfo">
				...
				<form id="form1" name="form1" method="post"
					...
					<table width="695" border="0" cellpadding="0" cellspacing="1"
						class="tabThSide">
						<tr>
							<th width="117" scope="row">調出倉庫代號</th>
							<td width="216"><?php echo ($sc["outwarehousecode"]); ?></td>
							<th width="91" scope="row">調出倉庫</th>
							<td width="266"><?php echo ($sc["outwarehousename"]); ?></td>
						</tr>
						<tr>
							<th scope="row">調入倉庫代號</th>
							<td><?php echo ($sc["inwarehousecode"]); ?></td>
							<th scope="row">調入倉庫</th>
							<td><?php echo ($sc["inwarehousename"]); ?></td>
						</tr>
						<tr>
							<th scope="row">調撥日期</th>
							<td><?php echo (date('Y/m/d',strtotime($sc["indate"]))); ?></td>
							<th scope="row">審核日期</th>
							<td><?php if(!empty($sc["checkdate"])): ?><?php echo (date('Y/m/d',strtotime($sc["checkdate"]))); ?><?php endif; ?></td>
						</tr>
						<tr>
							<th scope="row">調撥人</th>
							<td><?php echo ($sc["inuser"]); ?></td>
							<th scope="row">審核人</th>
					...
					<table width="695" border="0" cellpadding="0" cellspacing="0"
						class="tab_thtop">
						<tr>
							<th width="181" scope="col">商品編號</th>
							<th width="317" scope="col">商品名稱</th>
							<th width="64" scope="col">單價</th>
							<th width="60" scope="col">數量</th>
							<th width="71" scope="col">小計</th>
