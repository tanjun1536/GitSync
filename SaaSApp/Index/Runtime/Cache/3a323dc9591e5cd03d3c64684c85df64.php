...
<!-- 				</ul></li> -->
  ...
  <?php echo $_SESSION["caseName"];?>
			...
			<div class="topic">抄表管理 - 抄表紀錄列表</div>
			<div class="mainInfo">
				<div class="topic2">抄表紀錄</div>
				<form action="__URL__/copyFormHistoryEdit?id=<?php echo ($id); ?>" method="post"
					...
					<table width="695" border="0" cellpadding="0" cellspacing="1"
						...
						<?php if(is_array($copydetail)): $i = 0; $__LIST__ = $copydetail;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): ++$i;$mod = ($i % 2 )?><?php if($i%2 == 1): ?><tr>
							<?php else: ?>
						...
						<td align="center"><?php echo ($item["alldegree"]); ?></td>
						<td align="center"><?php echo ($item["thisdegree"]); ?></td>
