...
<script type="text/javascript">
	...
	function delay(s, complete) {
		return function(s, complete) {
			if (complete)
				clearTimeout(s);
		}
	}
				...
				<form action="__URL__/insert" onsubmit="return check()" method="post" enctype="multipart/form-data" name="form1" id="form1">
					<table width="695" border="0" align="center" cellpadding="0" cellspacing="1" class="tabThSide">
						<tr>
							...
							<td>
								<!-- <?php echo ($linecode); ?> --> <!-- <input type="hidden" name="ucode" value="<?php echo ($linecode); ?>" /> --> <input type="text" id="ucode" name="ucode" />
							</td>
						</tr>
						<tr>
							<th scope="row">帳號</th>
						...
						<tr>
							...
							<td><input type="file" name="userImage" /> <input type="hidden" value="<?php echo ($user["userimage"]); ?>" name="userimage" /> <input type="checkbox" name="delImage" value="1" /> 刪除相片</td>
						</tr>
						<tr>
							<th width="100" scope="row">姓名</th>
							<td width="592"><input type="text" name="name" /></td>
						</tr>
						<tr>
							<th scope="row">籍貫</th>
						...
						<tr>
							<th scope="row">性別</th>
							<td><input name="sex" checked="checked" type="radio" value="男" /> 男 <input name="sex" type="radio" value="女" /> 女</td>
						</tr>
						<tr>
							<th scope="row">生日</th>
						...
						<tr>
							...
							<td><input type="text" class="Wdate" onFocus="WdatePicker()" name="onduty" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td>
								<ul class="level">
									<?php if(is_array($levels)): $i = 0; $__LIST__ = $levels;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): ++$i;$mod = ($i % 2 )?><li><input type="checkbox" name="level[]" value="<?php echo ($item["id"]); ?>" /> <?php echo ($item["lcode"]); ?></li><?php endforeach; endif; else: echo "" ;endif; ?>
								</ul>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="text" class="Wdate" onFocus="WdatePicker()" name="offduty" /></td>
						</tr>
						<tr>
							<th scope="row">備註</th>
						...
						<tr>
							<th scope="row">經歷</th>
							<td>
								<table width="580" border="0" cellpadding="0" cellspacing="0" id="experience">
									<tr>
						...
						<tr>
							<th scope="row">學歷</th>
							<td>
								<table width="580" border="0" cellpadding="0" cellspacing="0" id="education">
									<tr>
						...
						<tr>
							<th scope="row">專長</th>
							<td>
								<table width="580" border="0" cellpadding="0" cellspacing="0" id="skill">
									<tr>
						...
						<tr>
							<th scope="row">兵役</th>
							<td><input name="army" type="radio" value="役畢" /> 役畢 <input name="army" type="radio" value="未服役" /> 未服役 <input name="army" type="radio" value="免役" /> 免役， 說明： <input type="text" name="armyremark" /></td>
						</tr>
						<tr>
							<th scope="row">家庭狀況</th>
							<td>
								<table width="580" border="0" cellpadding="0" cellspacing="0" id="family">
									<tr>
						...
						<tr>
							...
							<td><input type="text" name="linkman" style="width: 100px" /> 關係： <input type="text" name="linkrelation" style="width: 50px" /> 電話： <input type="text" name="linkphone" style="width: 120px" /> 手機： <input type="text" name="linkmobile" style="width: 120px" /></td>
						</tr>
						<tr>
							<th scope="row">&nbsp;</th>
