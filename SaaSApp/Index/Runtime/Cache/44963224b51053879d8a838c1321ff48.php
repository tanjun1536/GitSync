...
<?php if(is_array($TopMenu)): $i = 0; $__LIST__ = $TopMenu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): ++$i;$mod = ($i % 2 )?><?php if(empty($item["children"])): ?><li><a href="<?php echo ($item["link"]); ?>"><?php echo ($item["name"]); ?></a></li>
		...
		<li><a href="__APP__/Favorite">我的最愛</a>  </li>
			...
			<div class="mainInfo">
				<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
					...
					<table width="695" border="0" cellpadding="0" cellspacing="1" class="tabThSide">
						<tr>
							...
							<td width="602"><input type="text" name="sdate" class="Wdate" onfocus="WdatePicker()" />至<input type="text" name="edate" class="Wdate" onfocus="WdatePicker()" /></td>
						</tr>
						<tr>
				...
				<div class="mailNav">
					<?php if(check_power('新增',$ext) == 1): ?><a href="__URL__/addIncomePage">新增紀錄</a><?php endif; ?>
				...
				<form id="form2" name="form2" method="post" action="">
					<table width="695" border="0" cellpadding="0" cellspacing="0" class="tab_thtop">
						...
						<td align="center"><a href="__URL__/editIncome?id=<?php echo ($item["id"]); ?>">修改</a>|<a  onclick="return confirm('確認要刪除選擇的數據?');"  href="__URL__/deleteIncome?id=<?php echo ($item["id"]); ?>">刪除</a></td>
