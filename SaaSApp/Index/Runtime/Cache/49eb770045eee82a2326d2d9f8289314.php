  ...
  <?php echo $_SESSION["caseName"];?>
			...
			<div class="mainInfo">
				<form id="form1" name="form1" method="post" action="">
					<div class="mailNav">
						<?php if(check_power('新增',$ext) == 1): ?><a href="__URL__/addworkshift?case=<?php echo $_SESSION["case"];?>">新增調班單</a><?php endif; ?>
						調班單號 <input type="text" name="textfield" /> <select name="select">
							<option value="選擇月份">選擇月份</option>
							<option value="不限月份">不限月份</option>
				...
				<table width="695" border="0" cellpadding="0" cellspacing="0" class="tab_thtop">
					<tr>
						<th width="180" scope="col">調班單號</th>
						<th width="145" scope="col">調班月份</th>
						<th width="143" scope="col">KEY單時間</th>
						<th width="129" scope="col">KEY單人</th>
						<th width="96" scope="col">操作</th>
					</tr>
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): ++$i;$mod = ($i % 2 )?><?php if($i%2 == 1): ?><tr>
						...
						<td align="center"><a href="__URL__/workShiftView?id=<?php echo ($item["id"]); ?>"><?php echo ($item["movecode"]); ?></a></td>
						<td align="center"><?php echo ($item["movemonth"]); ?></td>
						<td align="center"><?php echo ($item["movetime"]); ?></td>
						<td align="center"><?php echo ($item["keyusername"]); ?></td>
						<td align="center"><a href="__URL__/workShiftUpdate?id=<?php echo ($item["id"]); ?>">修改</a> | <a onclick="return confirm('確認刪除選擇的數據?')" href="__URL__/workShiftDelete?id=<?php echo ($item["id"]); ?>">刪除</a></td>
