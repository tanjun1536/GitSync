...
<?php if(is_array($TopMenu)): $i = 0; $__LIST__ = $TopMenu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): ++$i;$mod = ($i % 2 )?><?php if(empty($item["children"])): ?><li><a href="<?php echo ($item["link"]); ?>"><?php echo ($item["name"]); ?></a></li>
		...
		<li><a href="__APP__/Favorite">我的最愛</a>  </li>
			...
			<div class="mainInfo">
				<div class="topic2"><?php echo ($name); ?></div>
				...
				<div class="mailNav">
				  <a href="__URL__/StockTest?id=<?php echo ($id); ?>">檢驗管理</a>
					<a href="__URL__/stockInventoryList?id=<?php echo ($id); ?>">盤點紀錄</a><a
						href="__URL__/stockChangeRecord?id=<?php echo ($id); ?>">異動紀錄</a>
				</div>
				<table width="695" border="0" cellpadding="0" cellspacing="0"
					class="tab_thtop">
					<tr>
						<th width="137" scope="col">商品編號</th>
						<th width="403" scope="col">商品名稱</th>
						<th width="77" scope="col">單價</th>
						<th width="76" scope="col">庫存量</th>
					</tr>
					...
					<td><?php echo ($item["p_all_name"]); ?></td>
