					...
					<table width="695" border="0" align="center" cellpadding="0"
						...
						<tr>
							...
							<td colspan="3"><select name="bigtype" id="bigtype">
									...
									<?php if(is_array($btypes)): $i = 0; $__LIST__ = $btypes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): ++$i;$mod = ($i % 2 )?><option value="<?php echo ($item["id"]); ?>"><?php echo ($item["s_name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
							</select>
						...
						<tr>
							...
							<td width="244"><input type="text" name="pcode" value="<?php echo ($code); ?>" /></td>
							<th width="114" scope="row">商品名稱</th>
							<td width="231"><input type="text" name="pname" value="<?php echo ($name); ?>" /></td>
						</tr>
						<tr>
							<th scope="row">&nbsp;</th>
...
<!-- 					<div class="mailNav"> -->
<!-- 						<?php if(check_power('新增商品',$ext) == 1): ?><a -->
<!-- 							href="__URL__/addProductPage">新增商品</a><?php endif; ?> -->
...
<!-- 							<th width="85" scope="col">操作</th> -->
						...
						<td align="center"><?php echo ($item["p_id"]); ?></td>
						<td align="center"><?php echo ($item["b_name"]); ?></td>
						<td><?php echo ($item["p_name"]); ?></td>
						<td align="center"><?php echo ($item["p_size"]); ?></td>
						<td align="center"><?php echo ($item["p_model"]); ?></td>
						<td align="right"><?php echo ($item["p_price"]); ?></td>
<!-- 						<td align="center"><xif -->
<!-- 								condition="check_power('修改商品',$ext) eq 1"> <a -->
<!-- 								href="__URL__/updateProduct?id=<?php echo ($item["id"]); ?>">修改</a> </xif> | <xif -->
<!-- 								condition="check_power('刪除商品',$ext) eq 1"> <a -->
<!-- 								onclick="return confirm('是否刪除該數據?')" -->
<!-- 								href="__URL__/deleteProduct?id=<?php echo ($item["id"]); ?>">刪除</a> </xif></td> -->
