...
<!-- 				</ul></li> -->
  ...
  <?php echo $_SESSION["caseName"];?>
			...
			<div class="topic">業主管理 - 抄表紀錄列表</div>
			<div class="mainInfo">
				<div class="topic2">抄表紀錄列表</div>
				<form id="form1" name="form1" method="post" action="">
					<div class="mailNav">
						<a href="__URL__/copyFormHistoryAddPage">新增抄表紀錄</a> 日期<input
							type="text" name="sdate" class="Wdate" onfocus="WdatePicker()" /><input
				...
				<table width="695" border="0" cellpadding="0" cellspacing="0"
					class="tab_thtop">
					<tr>
						<th width="192" scope="col">日期</th>
						<th width="238" scope="col">抄表時間</th>
						<th width="104" scope="col">抄表人</th>
						<th width="159" scope="col">操作</th>
					</tr>
					...
					<td align="center"><?php echo (date('Y/m/d',strtotime($item["copydate"]))); ?></td>
					<td align="center"><?php echo (date('Y/m/d
						h:i:s',strtotime($item["copydatetime"]))); ?></td>
					<td align="center"><?php echo ($item["copyuser"]); ?></td>
					<td align="center"><a
						href="__URL__/copyFormHistoryEdit?id=<?php echo ($item["id"]); ?>">修改</a> | <a
						onclick="return confirm('是否刪除選擇的數據?')"
						href="__URL__/copyFormHistoryDelete?id=<?php echo ($item["id"]); ?>">刪除</a> | <a
						href="__URL__/copyFormHistoryView?id=<?php echo ($item["id"]); ?>">詳細資料</a></td>
