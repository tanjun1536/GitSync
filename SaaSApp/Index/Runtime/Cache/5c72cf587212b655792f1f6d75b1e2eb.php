...
<?php if(is_array($TopMenu)): $i = 0; $__LIST__ = $TopMenu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): ++$i;$mod = ($i % 2 )?><?php if(empty($item["children"])): ?><li><a href="<?php echo ($item["link"]); ?>"><?php echo ($item["name"]); ?></a></li>
		...
		<li><a href="__APP__/Favorite">我的最愛</a>  </li>
			...
			<div class="mainInfo">
				<form id="form1" name="form1" method="post" action="">
					...
					<table width="695" border="0" cellpadding="0" cellspacing="1" class="tabThSide">
						<tr>
							...
							<td width="244"><input type="text" name="textfield2" /></td>
							<th width="121" scope="row">狀態</th>
							<td width="225"><select name="select">
				...
				<div class="topic2">客戶詢價列表</div>
				<div class="mailNav">
					<a href="__URL__/PriceBusinessAdd">新增詢價單</a>
				</div>
				<form id="form2" name="form2" method="post" action="">
					<table width="695" border="0" cellpadding="0" cellspacing="0" class="tab_thtop">
						<tr>
							<th width="147" scope="col">詢價單編號</th>
							<th width="143" scope="col">日期</th>
							<th width="143" scope="col">類別</th>
							<th width="136" scope="col">詢價人</th>
							<th width="131" scope="col">狀態</th>
							<th width="156" scope="col">操作</th>
						</tr>
						...
						<td align="center"><?php echo ($item["querycode"]); ?></td>
						<td align="center"><?php echo (date('Y/m/d',strtotime($item["querydate"]))); ?></td>
						<td align="center"><?php echo ($item["type"]); ?></td>
						<td align="center"><?php echo ($item["uname"]); ?></td>
						<td align="center"><?php echo ($item["state"]); ?></td>
						<td align="center"><a href="__URL__/PriceBusinessEdit?id=<?php echo ($item["id"]); ?>">修改</a> |<a onclick="return confirm('是否刪除選擇的數據?')" href="__URL__/PriceBusinessDelete?id=<?php echo ($item["id"]); ?>"> 刪除</a> | <a href="#">列印</a></td>
