...
<!-- 				</ul></li> -->
  ...
  <?php echo $_SESSION["caseName"];?>
			...
			<div class="mainInfo">
				<div class="mailNav">
					<a href="__URL__/editContent?id=<?php echo $_SESSION["case"];?>">修改專案</a>
				</div>
				<div align="center">
					<p>
						<img src="__PUBLIC__/Uploads/atts/case/<?php echo ($c["atts"]); ?>" alt="" width="538" height="338" />
					</p>
				</div>
				<div align="center"><?php echo ($c["cont"]); ?></div>
			</div>
		</div>
	</div>
