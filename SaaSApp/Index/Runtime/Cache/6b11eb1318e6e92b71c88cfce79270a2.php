...
<?php if(is_array($TopMenu)): $i = 0; $__LIST__ = $TopMenu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): ++$i;$mod = ($i % 2 )?><?php if(empty($item["children"])): ?><li><a href="<?php echo ($item["link"]); ?>"><?php echo ($item["name"]); ?></a></li>
		...
		<li><a href="__APP__/Favorite">我的最愛</a>  </li>
			...
			<div class="topic">業務管理 - 業務資料追蹤表</div>
			<div class="mainInfo">
				<table width="695" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td><div class="topic2">追蹤紀錄</div></td>
						<td valign="bottom"><div class="mailNav">
								<a href="__URL__/edit?id=<?php echo ($business["id"]); ?>">修改紀錄</a>
							</div></td>
					</tr>
				</table>
				<table width="695" border="0" cellpadding="0" cellspacing="1" class="tabThSide">
					<tr>
						<th width="110" scope="row">日期</th>
						<td width="582"><?php echo ($business["date"]); ?></td>
					</tr>
					<tr>
						<th scope="row">時間</th>
						<td>開始 <?php echo ($business["shour"]); ?> ： <?php echo ($business["sminute"]); ?> ；結束 <?php echo ($business["ehour"]); ?> ： <?php echo ($business["eminute"]); ?></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><?php echo ($business["businesscode"]); ?></td>
					</tr>
					<tr>
						<th scope="row">聯絡人</th>
						<td><strong>姓名：</strong><?php echo ($business["linkername"]); ?>；<strong>職位：</strong><?php echo ($business["linkerphone"]); ?> <br /> <strong>電話：</strong><?php echo ($business["linkerphone"]); ?><br /> <strong>手機：</strong> <?php echo ($business["linkermobile"]); ?><br /> <strong>Email：</strong><?php echo ($business["linkeremail"]); ?></td>
					</tr>
					<tr>
						<th scope="row">互動方式</th>
						<td><?php echo ($business["interactiveway"]); ?></td>
					</tr>
					<tr>
						<th scope="row">具體事項</th>
						<td><?php echo ($business["specificmatters"]); ?></td>
					</tr>
					<tr>
						<th scope="row">狀態</th>
						<td><?php echo ($business["state"]); ?></td>
					</tr>
					<tr>
						<th scope="row">提醒</th>
						<td><?php if($business["state"] == 1): ?>加入提醒<?php else: ?>未加入提醒<?php endif; ?></td>
					</tr>
					<tr>
						<th scope="row">詳細說明</th>
						<td><label><?php echo ($business["detail"]); ?></label></td>
					</tr>
				</table>
				<div class="back">
