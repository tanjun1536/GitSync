...
<script type="text/javascript">
	var pronvice1 = "<?php echo ($customer["province1"]); ?>";
	var pronvice2 = "<?php echo ($customer["province2"]); ?>";
	var city1 = "<?php echo ($customer["city1"]); ?>";
	var city2 = "<?php echo ($customer["city2"]); ?>";
	var isopen = "<?php echo ($customer["isopen"]); ?>";
	$(function() {
			...
			<div class="mainInfo">
				...
				<table width="695" border="0" cellpadding="0" cellspacing="1" class="tabThSide">
					<tr>
						...
						<td width="582"><?php echo ($customer["companyname"]); ?></td>
					</tr>
					<tr>
						<th scope="row">統一編號</th>
						<td><?php echo ($customer["uniquecode"]); ?></td>
					</tr>
					<tr>
						<th scope="row">公司電話</th>
						<td>電話一 ：<?php echo ($customer["phone1"]); ?><br /> 電話二 ：<?php echo ($customer["phone2"]); ?>
						</td>
					</tr>
					<tr>
						<th scope="row">傳真</th>
					...
					<tr>
						...
						<td>地址一 ：<?php echo ($province1); ?><?php echo ($city1); ?><?php echo ($customer["address1"]); ?><br /> 地址二 ：<?php echo ($province2); ?><?php echo ($city2); ?><?php echo ($customer["address2"]); ?>
						</td>
					</tr>
					<tr>
						<th scope="row">聯絡人一</th>
						<td>姓名 ： <?php echo ($customer["linkername1"]); ?> <br /> 職位 ：<?php echo ($customer["linkerduty1"]); ?><br /> 電話 ：<?php echo ($customer["linkerphone1"]); ?> ；手機：<?php echo ($customer["linkermobile1"]); ?> <br /> Email ：<?php echo ($customer["linkeremail1"]); ?>
						</td>
					</tr>
					<tr>
						<th scope="row"><p>聯絡人二</p></th>
						<td>姓名 ：  <?php echo ($customer["linkername2"]); ?><br /> 職位 ：<?php echo ($customer["linkerduty2"]); ?><br /> 電話 ：<?php echo ($customer["linkerphone2"]); ?>；手機：<?php echo ($customer["linkermobile2"]); ?> <br /> Email ：<?php echo ($customer["linkeremail2"]); ?>
						</td>
					</tr>
					<tr>
						<th scope="row">開啟帳號</th>
						<td><?php if(($item["isopen"])  ==  "1"): ?>是<?php else: ?>否<?php endif; ?></td>
					</tr>
<!-- 					<tr> -->
<!-- 						<th scope="row">帳號</th> -->
<!-- 						<td>&nbsp;</td> -->
