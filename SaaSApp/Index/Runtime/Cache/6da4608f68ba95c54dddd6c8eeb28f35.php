...
<?php if(is_array($TopMenu)): $i = 0; $__LIST__ = $TopMenu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): ++$i;$mod = ($i % 2 )?><?php if(empty($item["children"])): ?><li><a href="<?php echo ($item["link"]); ?>"><?php echo ($item["name"]); ?></a></li>
		...
		<li><a href="__APP__/Favorite">我的最愛</a>  </li>
			...
			<div class="mainInfo">
				<div class="topic2">審核入庫單</div>
				<form id="form1" name="form1" method="post" action="__URL__/stockChangeCheck">
					<input type="hidden" name="id" value="<?php echo ($sc["id"]); ?>" />
					<input type="hidden" name="state" id="state" />
					<table width="695" border="0" cellpadding="0" cellspacing="1" class="tabThSide">
							<tr>
						<th width="91" scope="row">倉庫代號</th>
						<td width="242"><?php echo ($sc["inwarehousecode"]); ?></td>
						<th width="91" scope="row">倉庫名稱</th>
						<td width="266"><?php echo ($sc["inwarehousename"]); ?></td>
					</tr>
					<tr>
						<th scope="row">入庫日期</th>
						<td><?php echo (date('Y/m/d',strtotime($sc["indate"]))); ?></td>
						<th scope="row">入庫性質</th>
						<td><?php echo ($sc["intypename"]); ?></td>
					</tr>
<!-- 					<tr> -->
<!-- 						<th scope="row">对象</th> -->
<!-- 						<td colspan="3"><?php echo ($sc["objtype"]); ?></td> -->
...
<!-- 					</tr> -->
					<tr>
						...
						<td><?php echo ($sc["inhour"]); ?>時<?php echo ($sc["inminute"]); ?>分</td>
					</tr>
					<tr>
					...
					<tr>
						<th scope="row">對象</th>
						<td colspan="3"><?php echo ($obj["name"]); ?></td>
<!-- 						<th scope="row">訂單編號</th> -->
<!-- 						<td><?php echo ($sc["ordercode"]); ?></td> -->
					</tr>
					<tr>
						<th scope="row">入庫單號</th>
						<td colspan="3"><?php echo ($sc["incode"]); ?></td>
					</tr>
					<tr>
						<th scope="row">備註</th>
