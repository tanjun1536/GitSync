...
<div class="webPage"><script type="text/javascript" src="__PUBLIC__/js/My97DatePicker/WdatePicker.js"></script>
<div class="sideLeft">
	<div>
...
<div class="topic">工作日誌</div>
<div class="mainInfo">
<table width="695" border="0" cellpadding="0" cellspacing="1" class="tabThSide">
	<tr>
		<th scope="row">員工</th>
		<td><?php echo ($work["uname"]); ?></td>
	</tr>
	<tr>
		<th width="92" scope="row">日期</th>
		<td width="600"><?php echo (date('Y/m/d',strtotime($work["date"]))); ?></td>
	</tr>
	<tr>
		<th scope="row">時間</th>
		<td><?php echo ($work["shour"]); ?>：<?php echo ($work["sminute"]); ?> 開始 ； <?php echo ($work["ehour"]); ?>：<?php echo ($work["eminute"]); ?> 結束</td>
	</tr>
	<tr>
		<th scope="row">簡述</th>
	...
	<tr>
		<th scope="row">提醒</th>
		<td><?php if(($work["awoke"])  ==  "0"): ?>不提醒<?php else: ?>提醒<?php endif; ?></td>
	</tr>
</table>
<div class="back"><a href="javascript:window.history.go(-1)">》回上頁</a></div>
</div>
</div>
</div>
