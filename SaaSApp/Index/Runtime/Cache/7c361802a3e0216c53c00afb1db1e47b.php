...
<script type="text/javascript">
	$(function(){
		...
		$("input[name='pay'][value='<?php echo ($obj["paymanner"]); ?>']").val('∨');
		$("input[name='bill'][value='<?php echo ($obj["billtype"]); ?>']").val('∨');
	});
</script>
</head>
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="340" height="22">和新機電管理股份有限公司</td>
    <td width="175" rowspan="3"><h1><?php echo ($typename); ?></h1></td>
    <td width="61">公司電話：</td>
...
<table width="800" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="61" height="22">客戶名稱：</td>
    <td width="269"><?php echo ($obj["clienttitle"]); ?></td>
    <td width="62">客戶統編：</td>
    <td width="136"><?php echo ($obj["clientcode"]); ?></td>
    <td width="61">單位名稱：</td>
    <td width="69"><?php echo ($obj["unit1"]); ?></td>
    <td width="61">貨單日期：</td>
    <td width="81"><?php echo ($sc["outdate"]); ?></td>
  </tr>
  <tr>
    <td height="22">客戶地址：</td>
    <td><?php echo ($obj["provName"]); ?><?php echo ($obj["cityName"]); ?><?php echo ($obj["clientaddress"]); ?></td>
    <td>客戶電話：</td>
    <td><?php echo ($obj["phone1"]); ?></td>
    <td>聯絡人：</td>
    <td><?php echo ($obj["linkername1"]); ?></td>
    <td>出貨單號：</td>
    <td><?php echo ($sc["outcode"]); ?></td>
  </tr>
  <tr>
    <td height="22">送貨案場：</td>
    <td><?php echo ($obj["deliveraddress"]); ?></td>
    <td>客戶傳真：</td>
  ...
  <tr>
    ...
    <td><?php echo ($obj["dprovName"]); ?><?php echo ($obj["dcityName"]); ?><?php echo ($obj["deliveraddress"]); ?></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
<table width="800" border="0" cellpadding="0" cellspacing="0" class="tab_pdlist">
  ...
  <tr>
    <td colspan="8" rowspan="3" align="center" class="tdline"><table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:0; border:none">
      <tr>
        <td width="10%">發票類型：</td>
        <td width="4%"><input name="bill" type="text" class="checkbox" /></td>
        <td width="6%"> 二聯</td>
        <td width="4%"><input name="bill" type="text" class="checkbox" /></td>
        <td width="6%">三連</td>
        <td width="4%">&nbsp;</td>
      ...
      <tr>
        <td>付款方式：</td>
        <td><input name="pay" type="text" class="checkbox"  /></td>
        <td>匯款</td>
        <td><input name="pay" type="text" class="checkbox" /></td>
        <td>現金</td>
        <td><input name="pay" type="text" class="checkbox" /></td>
      ...
      <tr>
        <td>送貨方式：</td>
        <td><input name="deliver" type="text" class="checkbox" /></td>
        <td>配送</td>
        <td><input name="deliver" type="text" class="checkbox" /></td>
        <td>郵寄</td>
        <td><input name="deliver" type="text" class="checkbox" /></td>
