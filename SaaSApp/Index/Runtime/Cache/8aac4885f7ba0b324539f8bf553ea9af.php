...
<script type="text/JavaScript">
	var bt = "<?php echo ($ct["btype"]); ?>";
	var mt = "<?php echo ($ct["mtype"]); ?>";
	$(function() {
		...
		<li><a href="__APP__/Favorite">我的最愛</a>  </li>
			...
			<div class="mainInfo">
				<form action="__URL__/addProductChildType" method="post" enctype="multipart/form-data" name="form1" id="form1">
					<input type="hidden" name="id" style="width: 400px" value="<?php echo ($ct["id"]); ?>" />
...
<!-- 									<option value="<?php echo ($item["id"]); ?>"><?php echo ($item["name"]); ?></option> -->
<!--<?php endforeach; endif; else: echo "" ;endif; ?> -->
<!-- 							</select> <input type="text" name="name" value="<?php echo ($ct["name"]); ?>" /> <input type="submit" name="Submit" value="確定" /></td> -->
<!-- 						</tr> -->
<!-- 					</table> -->
				</form>
				<form id="form2" name="form2" method="post" action="">
					...
					<table width="695" border="0" cellpadding="0" cellspacing="0" class="tab_thtop">
						...
						<td align="center"><?php echo ($item["c1name"]); ?></td>
						<td align="center"><a href="__URL__/productCChildType?bt=<?php echo ($item["bid"]); ?>&mt=<?php echo ($item["mid"]); ?>&ct=<?php echo ($item["id"]); ?>"><?php echo ($item["c2name"]); ?></a></td>
						<td align="center"><a href="__URL__/updateProductChildType?id=<?php echo ($item["id"]); ?>">修改</a> | <a onclick="return confirm('是否刪除該數據?')" href="__URL__/deleteProductChildType?id=<?php echo ($item["id"]); ?>">刪除</a></td>
