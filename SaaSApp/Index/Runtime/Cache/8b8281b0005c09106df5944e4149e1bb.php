			...
			<div class="mainInfo">
				<form id="form2" name="form2" method="post" action="">
					<div class="mailNav">
						...
						</select> 姓名：<input type="text" name="skey" value="<?php echo ($username); ?>" /><input type="submit" name="Submit3" value="搜尋" />
					</div>
					<table width="695" border="0" cellpadding="0" cellspacing="0"
						...
						<td align="center"><?php echo ($item["dname"]); ?></td>
						<td align="center"><?php echo ($item["tname"]); ?></td>
						<td align="center"><?php echo ($item["id"]); ?></td>
						<td align="center"><?php echo ($item["name"]); ?></td>
						<td align="center"><?php echo ($item["ucode"]); ?></td>
						<td align="center"><?php echo ($item["phone"]); ?></td>
						<td align="center"><?php echo ($item["email"]); ?></td>
						<td align="center"><?php if(($item["isonduty"])  ==  "1"): ?>在職<?php else: ?>離職<?php endif; ?></td>
						<td align="center"><a href="__URL__/edit?id=<?php echo ($item["id"]); ?>">修改</a>
