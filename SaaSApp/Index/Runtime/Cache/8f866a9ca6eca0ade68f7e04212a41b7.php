			...
			<div class="mainInfo">
				<div style="margin-bottom: 10px">
					<form id="form1" name="form1" method="post" action="">
						...
						</strong> <input type="text" name="sdate" class="Wdate" value="<?php echo ($sdate); ?>" onfocus="WdatePicker()" style="width: 100px" /> ~ <input type="text" value="<?php echo ($edate); ?>" class="Wdate" onfocus="WdatePicker()"  name="edate" style="width: 100px" /> <input type="submit" name="Submit" value="搜尋" />
					</form>
				</div>
				<table width="695" border="0" cellpadding="0" cellspacing="0" class="tab_thtop">
					...
					<td align="center"><?php echo ($item["downtime"]); ?></td>
