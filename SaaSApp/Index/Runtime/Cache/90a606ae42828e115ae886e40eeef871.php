...
<?php if(is_array($TopMenu)): $i = 0; $__LIST__ = $TopMenu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): ++$i;$mod = ($i % 2 )?><?php if(empty($item["children"])): ?><li><a href="<?php echo ($item["link"]); ?>"><?php echo ($item["name"]); ?></a></li>
		...
		<li><a href="__APP__/Favorite">我的最愛</a>  </li>
			...
			<div class="mainInfo">
				<div class="topic2">
					<a href="__URL__/stockView?id=<?php echo ($stock["id"]); ?>"><?php echo ($stock["stockname"]); ?></a> - 盤點紀錄
				</div>
				<table width="695" border="0" cellpadding="0" cellspacing="1"
					...
					<tr>
						<th scope="row">盤點結束日期</th>
						<td><?php echo (formatDate($inventory["enddate"])); ?></td>
						<th scope="row">倉庫開啟時間</th>
						<td><?php echo ($inventory["stockopenhour"]); ?>:<?php echo ($inventory["stockopenminute"]); ?></td>
					</tr>
					<tr>
						<th scope="row">盤點紀錄人</th>
						<td colspan="3"><?php echo ($inventory["inventoryuser"]); ?></td>
					</tr>
				</table>
				<form action="__URL__/stockInventoryView?id=<?php echo $_GET["id"];?>&stockid=<?php echo $_GET["stockid"];?>" method="post"
					enctype="multipart/form-data" name="form1" id="form1">
					<div class="mailNav">
						<a href="__URL__/stockInventoryAdd?id=<?php echo $_GET["id"];?>&stockid=<?php echo $_GET["stockid"];?>">新增紀錄</a>狀態搜尋 <select
							name="state" id="state">
					...
					<table width="695" border="0" cellpadding="0" cellspacing="0"
						...
						<tr>
							...
							<th width="161" scope="col">商品編號</th>
							<th width="231" scope="col">商品名稱</th>
							<th width="61" scope="col">單價</th>
							<th width="84" scope="col">預估數量</th>
							<th width="75" scope="col">實際數量</th>
						...
						<td align="center"><?php echo ($item["productfactquantity"]); ?></td>
