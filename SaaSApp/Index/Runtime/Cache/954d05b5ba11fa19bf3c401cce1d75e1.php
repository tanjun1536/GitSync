...
<?php if(is_array($TopMenu)): $i = 0; $__LIST__ = $TopMenu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): ++$i;$mod = ($i % 2 )?><?php if(empty($item["children"])): ?><li><a href="<?php echo ($item["link"]); ?>"><?php echo ($item["name"]); ?></a></li>
		...
		<li><a href="__APP__/Favorite">我的最愛</a>  </li>
			...
			<div class="mainInfo">
				<form id="form1" name="form1" method="post" action="__URL__/bid">
					<div class="topic2">業務報價搜尋</div>
					<table width="695" border="0" cellpadding="0" cellspacing="1" class="tabThSide">
						<tr>
							<th width="100" scope="row">客戶名稱</th>
							<td width="244"><input type="text" name="sclientname" /></td>
							<th width="121" scope="row">狀態</th>
							<td width="225"><select name="sstate">
						...
						<tr>
							...
							<td colspan="3"><input type="text" name="sbiddate" class="Wdate" onfocus="WdatePicker()" /></td>
						</tr>
						<tr>
							<th scope="row">&nbsp;</th>
				...
				<div class="topic2">業務報價列表</div>
				<div class="mailNav">
					<a href="__URL__/addBidPage">新增報價單</a>
				</div>
				<form id="form2" name="form2" method="post" action="">
					<table width="695" border="0" cellpadding="0" cellspacing="0" class="tab_thtop">
						<tr>
							<th width="128" scope="col">報價單編號</th>
							<th width="96" scope="col">報價日期</th>
							<th width="196" scope="col">客戶名稱</th>
							<th width="78" scope="col">聯絡人</th>
							<th width="86" scope="col">成交金額</th>
							<th width="57" scope="col">狀態</th>
							<th width="52" scope="col">操作</th>
						</tr>
						...
						<td align="center"><a href="__URL__/viewBid?id=<?php echo ($item["id"]); ?>"><?php echo ($item["bidcode"]); ?></a></td>
						<td align="center"><?php echo (date('Y/m/d',strtotime($item["biddate"]))); ?></td>
						<td align="center"><?php echo ($item["clientname"]); ?></td>
						<td align="center"><?php echo ($item["linker"]); ?></td>
						<td align="center"><?php echo ($item["bidprice"]); ?></td>
						<td align="center"><?php echo ($item["state"]); ?></td>
						<td align="center"><a href="__URL__/editBid?id=<?php echo ($item["id"]); ?>">修改</a><br /> <a onclick="return confirm('是否刪除選擇的數據?')" href="__URL__/deleteBid?id=<?php echo ($item["id"]); ?>">刪除</a><br /> <a href="#" onclick="MM_openBrWindow('__URL__/printBid','業務報價單','toolbar=yes,scrollbars=yes,width=780,height=650')">列印</a></td>
