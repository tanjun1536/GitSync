			...
			<div class="mainInfo">
				<div class="mailNav">
					<form id="form2" name="form2" method="post" action="">
						<a href="__URL__/add">新增簽呈</a>
						<a href="__URL__/index">寄出的簽呈</a>
						<a href="__URL__/receive" class="select">收到的簽呈</a> 開始日期 <input type="text" name="requesterdate" class="Wdate" onfocus="WdatePicker();" style="width: 100px" /> <select name="state">
				...
				<form id="form1" name="form1" method="post" action="__URL__/aggree">
					<table width="695" border="0" cellpadding="0" cellspacing="0" class="mailList">
						<tr>
							<th width="28" scope="col">&nbsp;</th>
							<th width="74" scope="col">申請日期</th>
							<th width="63" scope="col">申請人</th>
							<th width="95" scope="col">類別</th>
							<th width="242" scope="col">名稱</th>
							<th width="139" scope="col">起迄時間</th>
						...
						<td><?php echo ($item["requestername"]); ?> <br /> (<?php echo ($item["requestercode"]); ?>)
						</td>
						<td><?php echo ($item["typename"]); ?></td>
						<td><a href="__URL__/check?id=<?php echo ($item["id"]); ?>"><?php echo ($item["typechildname"]); ?></a></td>
					...
					<div style="margin-top: 10px">
						<input type="submit" name="Submit" value="簽核同意" /> <label></label>
					</div>
				</form>
