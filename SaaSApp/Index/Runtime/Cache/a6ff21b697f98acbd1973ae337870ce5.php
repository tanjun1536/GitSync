		...
		<li><a href="__APP__/Favorite">我的最愛</a>  </li>
			...
			<div class="mainInfo">
				<form id="form1" name="form1" method="post" action="">
					<div class="mailNav">
						<a href="__URL__/addBudgetPage">新增預算編列資料</a> 日期<input type="text"
							name="sdate"  class="Wdate" onfocus="WdatePicker()"/> 預算名稱 <input type="text" name="ysm" /> <input
				...
				<table width="695" border="0" cellpadding="0" cellspacing="0"
					class="tab_thtop">
					<tr>
						<th width="125" scope="col">建立日期</th>
						<th width="343" scope="col">預算名稱</th>
						<th width="141" scope="col">編列人</th>
					...
					<td align="center"><?php echo (date('Y-m-d',strtotime($item["createdate"]))); ?></td>
					<td><a href="__URL__/viewBudget?id=<?php echo ($item["id"]); ?>"><?php echo ($item["name"]); ?></a></td>
					<td align="center"><?php echo ($item["createuser"]); ?></td>
					<td><a href="__URL__/editBudget?id=<?php echo ($item["id"]); ?>">修改</a> | <a
						href="__URL__/deleteBudget?id=<?php echo ($item["id"]); ?>"
