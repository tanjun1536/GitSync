		...
		<li><a href="__APP__/Favorite">我的最愛</a>  </li>
			...
			<div class="mainInfo">
				<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1">
					<div class="topic2">收入搜尋</div>
					<table width="695" border="0" cellpadding="0" cellspacing="1" class="tabThSide">
						<tr>
							<th width="90" scope="row">日期</th>
							<td width="602"><input type="text" name="sindate" /></td>
						</tr>
						<tr>
							<th scope="row">付款方式</th>
							<td><select name="spaymode">
									<option  selected="selected">所有付款方式</option>
						...
						<tr>
							<th scope="row">狀態</th>
							<td><select name="spaystate">
									<option  selected="selected">所有狀態</option>
				...
				<div class="mailNav">
				<?php if(check_power('新增',$ext) == 1): ?><a href="__URL__/addPayPage">新增紀錄</a><?php endif; ?>
				...
				<form id="form2" name="form2" method="post" action="">
					<table width="695" border="0" cellpadding="0" cellspacing="0" class="tab_thtop">
						<tr>
							...
							<th width="24" scope="col">&nbsp;</th>
							<th width="84" scope="col">時間</th>
							<th width="168" scope="col">對象</th>
							<th width="70" scope="col">金額</th>
							<th width="74" scope="col">付款方式</th>
							<th width="54" scope="col">狀態</th>
						...
						<td align="center"><input type="checkbox" name="checkbox6" value="<?php echo ($item["id"]); ?>" /></td>
						<td align="center"><?php echo (date('Y/m/d',strtotime($item["indate"]))); ?></td>
						<td><?php echo ($item["objectname"]); ?></td>
						<td align="center"><?php echo ($item["billmoney"]); ?></td>
						<td align="center"><?php echo ($item["paymode"]); ?></td>
						<td align="center"><?php echo ($item["paystate"]); ?></td>
						<td align="center"><a href="__URL__/editPay?id=<?php echo ($item["id"]); ?>">修改</a></td>
						</tr><?php endforeach; endif; else: echo "" ;endif; ?>
					</table>
					<div style="margin-top: 10px">
						<?php if(check_power('拋轉傳票功能',$ext) == 1): ?><input type="submit" name="Submit2" value="拋轉所有傳票" /> 
						<input type="submit" name="Submit3" value="拋轉所有兌現傳票" /><?php endif; ?>
					</div>
				</form>
			</div>
		</div>
