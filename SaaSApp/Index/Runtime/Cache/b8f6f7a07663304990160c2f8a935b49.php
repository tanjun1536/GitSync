				...
				<form action="__URL__/insert" onsubmit="return check()" method="post" enctype="multipart/form-data" name="form1" id="form1">
					...
					<table width="695" border="0" cellpadding="0" cellspacing="1" class="tabThSide">
						...
						<tr>
							...
							<td width="557"><input type="text" name="date" id="date" class="Wdate" onfocus="WdatePicker()" /></td>
						</tr>
						<tr>
							<th scope="row">時間</th>
						...
						<tr>
							...
							<td><input type="text" name="companyname" style="width: 300px" /></td>
						</tr>
						<tr>
						...
						<tr>
							<th scope="row">聯絡人</th>
							<td>姓名 <input type="text" name="linkername" /> ；職位 <input type="text" name="linkerduty" /> <br /> 電話 <input type="text" name="linkerphone" /> ；手機 <input type="text" name="linkermobile" /> <br /> Email <input type="text" name="linkeremail" /></td>
						</tr>
						<tr>
							<th scope="row">互動方式</th>
							<td><input name="interactiveway" type="radio" value="電話聯繫" checked="checked" /> 電話聯繫 <input name="interactiveway" type="radio" value="親自拜訪" /> 親自拜訪</td>
						</tr>
						<tr>
						...
						<tr>
							<th scope="row">狀態</th>
							<td><input name="state" type="radio" value="預訂工作" checked="checked" /> 預訂工作 <input name="state" type="radio" value="完成工作" /> 完成工作</td>
						</tr>
						<tr>
							<th scope="row">提醒</th>
							<td><input name="awoke" type="radio" value="1" /> 加入提醒 <input name="awoke" type="radio" value="0" checked="checked" /> 不提醒</td>
						</tr>
						<tr>
							<th scope="row">詳細說明</th>
							<td><label> <textarea name="detail" rows="6" style="width: 500px"></textarea>
							</label></td>
						</tr>
						<tr>
							<th scope="row">&nbsp;</th>
