		...
		<li><a href="__APP__/Favorite">我的最愛</a>  </li>
			...
			<div class="mainInfo">
				<form action="__URL__/insert" method="post" enctype="multipart/form-data" name="form1" id="form1">
					<div class="topic2">新增 / 修改合約</div>
					<table width="695" border="0" cellpadding="0" cellspacing="1" class="tabThSide">
						<tr>
							<th scope="row">合約編號</th>
							<td><input type="text" name="signcode" /></td>
						</tr>
						<tr>
							<th width="161" scope="row">公司名稱</th>
							<td width="531"><input type="text" name="companyname"  style="width: 300px" /></td>
						</tr>
						<tr>
							<th scope="row">簽約日期</th>
							<td><input type="text" name="signdate" class="Wdate" onfocus="WdatePicker()" /></td>
						</tr>
						<tr>
							<th scope="row">合約起訖日</th>
							<td><input type="text" name="sdate" class="Wdate" onfocus="WdatePicker()" /> ~ <input type="text" name="edate" class="Wdate" onfocus="WdatePicker()" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><textarea name="content" rows="10" style="width: 500px"></textarea></td>
						</tr>
						<tr>
							<th scope="row">&nbsp;</th>
