...
<!-- 				</ul></li> -->
  ...
  <?php echo $_SESSION["caseName"];?>
			...
			<div class="mainInfo">
				<div class="mailNav">
					<a href="__URL__/addRepair?case=<?php echo $_SESSION["case"];?>&tid=<?php echo ($ins["tid"]); ?>&ctid=<?php echo ($ins["ctid"]); ?>&devicecode=<?php echo ($ins["devicecode"]); ?>">申請叫修</a><a href="__URL__/editMaintenanceRecord?case=<?php echo $_SESSION["case"];?>&id=<?php echo ($ins["id"]); ?>">修改</a>
				</div>
				<table width="695" border="0" cellpadding="0" cellspacing="1" class="tabThSide">
					<tr>
						<th scope="row">保養編號</th>
						<td><?php echo ($ins["maintenancecode"]); ?></td>
						<th width="93" scope="row">保養日期</th>
						<td><?php echo (date('Y/m/d',strtotime($ins["maintenancedate"]))); ?></td>
					</tr>
					<tr>
						<th width="103" scope="row">保養人</th>
						<td width="203"><?php echo ($ins["maintenanceuser"]); ?></td>
						<th scope="row">設備類別</th>
						<td width="291"><?php echo ($ins["tname"]); ?>/ <?php echo ($ins["ctname"]); ?></td>
					</tr>
					<tr>
						<th scope="row">設備編號</th>
						<td colspan="3"><?php echo ($ins["devicecode"]); ?></td>
					</tr>
					<tr>
						<th scope="row">設備名稱</th>
						<td colspan="3"><?php echo ($ins["devicename"]); ?></td>
					</tr>
				</table>
				<div class="topic2">保養明細</div>
				<table width="695" border="0" cellpadding="0" cellspacing="0" class="tab_thtop">
					<tr>
						<th width="144" scope="col">項目</th>
						<th width="109" scope="col">正常資料</th>
						<th width="80" scope="col">實際資料</th>
						<th width="164" scope="col">說明</th>
						<th width="134" scope="col">備註</th>
						...
						<td align="center"><?php if($item["type"] == '一般' ): ?>一般<?php else: ?>下限<?php echo ($item["floor"]); ?>上限<?php echo ($item["cap"]); ?><?php endif; ?></td>
						<td align="center"><?php if($item["result"] == '正常' ): ?>正常<?php elseif($item["result"] == '異常'): ?>異常<?php else: ?>數值<?php echo ($item["result"]); ?><?php endif; ?> </td>
						<td><?php echo ($item["descript"]); ?></td>
						<td><?php echo ($item["remark"]); ?></td>
						<td align="center"><?php echo ($item["cstate"]); ?></td>
