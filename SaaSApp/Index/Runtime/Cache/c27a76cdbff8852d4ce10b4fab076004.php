...
<script type="text/JavaScript">
	var sh="<?php echo ($work["shour"]); ?>";
	var sm="<?php echo ($work["sminute"]); ?>";
	var eh="<?php echo ($work["ehour"]); ?>";
	var em="<?php echo ($work["eminute"]); ?>";
	$(function(){
		if(sh) $("#shour").val(sh);
...
<!-- 				</ul></li> -->
  ...
  <?php echo $_SESSION["caseName"];?>
			...
			<div class="mainInfo">
				<form action="__URL__/addWork?case=<?php echo $_SESSION["case"];?>" onsubmit="return check();" method="post" enctype="multipart/form-data" name="form1" id="form1">
					...
					<table width="695" border="0" cellpadding="0" cellspacing="1" class="tabThSide">
						<tr>
							...
							<td colspan="3"><input type="text" name="workcode" value="<?php echo ($work["workcode"]); ?>" style="width: 50px" /> 最多輸入 &quot;2個中文字&quot; 或 &quot;4個英文字母&quot;</td>
						</tr>
						<tr>
							...
							<td width="166"><input type="text" name="salary" value="<?php echo ($work["salary"]); ?>" style="width: 50px" /></td>
						</tr>
						<tr>
							<th scope="row">說明</th>
							<td colspan="3"><input type="text" name="remark" value="<?php echo ($work["remark"]); ?>" style="width: 500px" /></td>
						</tr>
						<tr>
							<th scope="row">&nbsp;</th>
				...
				<table width="695" border="0" cellpadding="0" cellspacing="0" class="tab_thtop">
					...
					<td align="center"><?php echo ($item["shour"]); ?>:<?php echo ($item["sminute"]); ?>~<?php echo ($item["ehour"]); ?>:<?php echo ($item["eminute"]); ?></td>
					<td align="center"><?php echo ($item["salary"]); ?></td>
					<td><?php echo ($item["remark"]); ?></td>
					<td align="center"><a href="__URL__/editWork?case=<?php echo $_SESSION["case"];?>&id=<?php echo ($item["id"]); ?>">修改</a> | <a onclick="return confirm('確認刪除選擇的數據?')" href="__URL__/deleteWork?case=<?php echo $_SESSION["case"];?>&id=<?php echo ($item["id"]); ?>">刪除</a></td>
