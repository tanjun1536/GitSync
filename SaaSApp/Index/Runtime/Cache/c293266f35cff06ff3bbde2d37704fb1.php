...
<!-- 				</ul></li> -->
  ...
  <?php echo $_SESSION["caseName"];?>
			...
			<div class="topic">保養管理 - 保養明細</div>
			<div class="mainInfo">
				<div class="mailNav">
					<form action="<?php echo ($action); ?>" method="post" id="f1">
						<a href="#" onclick="$('#f1').submit();" class="select">導出列表</a>
					</form>
				</div>
				<form id="form1" name="form1" method="post" action="__URL__/deleteMaintenanceRecord?case=<?php echo $_SESSION["case"];?>">
					<table width="695" border="0" cellpadding="0" cellspacing="0" class="tab_thtop">
						...
						<td align="center"><a href="__URL__/maintenanceRecordView?case=<?php echo $_SESSION["case"];?>&id=<?php echo ($item["id"]); ?>"><?php echo ($item["maintenancecode"]); ?></a></td>
						...
						<td align="center"><?php if($item["cstate"] == '異常' ): ?><span class="txt_red"><?php echo ($item["cstate"]); ?></span> <?php else: ?> <?php echo ($item["cstate"]); ?><?php endif; ?></td>
