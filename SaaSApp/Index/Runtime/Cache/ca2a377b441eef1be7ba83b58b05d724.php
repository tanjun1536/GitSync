                ...
                <div class="mainInfo">
                    ...
                    <table width="695" border="0" cellpadding="0" cellspacing="0" class="tab_thtop">
                        ...
                        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): ++$i;$mod = ($i % 2 )?><?php if($i%2 == 1): ?><tr>
                            ...
                            <td align="center"><a href="__APP__/User/limit?role=<?php echo ($item["id"]); ?>" ><?php echo ($item["users"]); ?></a></td>
                            <td align="center"><a href="__URL__/edit?id=<?php echo ($item["id"]); ?>">修改</a> | <a onclick=" return confirm('確認要刪除選擇的數據嗎？'); " href="__URL__/delete?id=<?php echo ($item["id"]); ?>">刪除</a></td>
