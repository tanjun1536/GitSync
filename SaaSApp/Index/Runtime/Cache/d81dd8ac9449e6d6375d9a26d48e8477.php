...
var province="<?php echo ($title["province"]); ?>";
var city="<?php echo ($title["city"]); ?>";
$(function() {
...
<?php if(is_array($TopMenu)): $i = 0; $__LIST__ = $TopMenu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): ++$i;$mod = ($i % 2 )?><?php if(empty($item["children"])): ?><li><a href="<?php echo ($item["link"]); ?>"><?php echo ($item["name"]); ?></a></li>
			...
			<div class="mainInfo">
				<form action="__URL__/TitleSave" method="post"
					...
					<input type="hidden" name="id" value="<?php echo ($title["id"]); ?>" /> <input
						type="hidden" name="code" value="<?php echo $_SESSION["SESSION_USER"]["code"];?>" />
					...
					<table width="695" border="0" cellpadding="0" cellspacing="1"
						...
						<tr>
							...
							<td width="562"><input type="text" name="chinesename"
								value="<?php echo ($title["chinesename"]); ?>" style="width: 350px" /></td>
						</tr>
						<tr>
							<th scope="row">公司英文名稱</th>
							<td><input type="text" name="englishname"
								value="<?php echo ($title["englishname"]); ?>" style="width: 350px" /></td>
						</tr>
						<tr>
							...
							<td><select name="province" id="province">
									...
									<option value="請選擇">請選擇</option>
							</select> <input type="text" name="address" value="<?php echo ($title["address"]); ?>"
								style="width: 300px" /></td>
						</tr>
						<tr>
							<th scope="row">公司電話</th>
							<td><input type="text" name="phone" value="<?php echo ($title["phone"]); ?>" /></td>
						</tr>
						<tr>
							<th scope="row">公司傳真</th>
							<td><input type="text" name="fax" value="<?php echo ($title["fax"]); ?>" /></td>
						</tr>
						<tr>
							<th scope="row">備註設定</th>
							<td><textarea name="remark" rows="4" style="width: 450px"><?php echo ($title["remark"]); ?></textarea></td>
						</tr>
						<tr>
							<th scope="row">&nbsp;</th>
