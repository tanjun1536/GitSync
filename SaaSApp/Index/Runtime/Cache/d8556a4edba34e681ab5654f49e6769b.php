		...
		<li><a href="__APP__/Favorite">我的最愛</a>  </li>
			...
			<div class="mainInfo">
				<table width="695" border="0" cellspacing="0" cellpadding="0">
					<tr>
						<td width="437"><div class="topic2">驗貨單</div></td>
						<td width="258" valign="bottom"><div class="mailNav">
								<a href="__URL__/updateStockCheck?id=<?php echo ($sc["id"]); ?>">修改驗貨單</a>
							</div></td>
					</tr>
				</table>
				<table width="695" border="0" cellpadding="0" cellspacing="1" class="tabThSide">
					<tr>
						...
						<td width="296"><?php echo ($sc["checkcode"]); ?></td>
						<th width="83" scope="row">驗貨日期</th>
						<td width="211"><?php echo (date('Y/m/d',strtotime($sc["checkdate"]))); ?></td>
					</tr>
					<tr>
						<th scope="row">採購對象</th>
						<td><?php echo ($sc["manufacturer"]); ?></td>
						<th scope="row">採購者</th>
						<td><?php echo ($sc["purchaseuer"]); ?></td>
					</tr>
					<tr>
						<th scope="row">驗貨者</th>
						<td><?php echo ($sc["checkuser"]); ?></td>
						<th scope="row">審核者</th>
						<td><?php echo ($sc["puchasecheckuser"]); ?></td>
					</tr>
				</table>
				<table width="695" border="0" cellpadding="0" cellspacing="0" class="tab_thtop">
					...
					<td align="center"><?php echo ($item["purchasecode"]); ?></td>
					<td align="center"><?php echo ($item["productcode"]); ?></td>
					<td align="center"><?php echo ($item["productname"]); ?></td>
					<td align="center"><?php echo ($item["quantity"]); ?></td>
					<td align="center"><?php echo ($item["uncome"]); ?></td>
					<td align="center"><?php echo ($item["income"]); ?></td>
