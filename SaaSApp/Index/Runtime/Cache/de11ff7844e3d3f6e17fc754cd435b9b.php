		...
		<li><a href="__APP__/Favorite">我的最愛</a>  </li>
			...
			<div class="mainInfo">
				<form id="form1" name="form1" method="post" action="__URL__/PriceCustomerSave">
					...
					<input type="hidden" name="queryer" value="<?php echo $_SESSION["SESSION_USER"]["id"];?>" />
					<input type="hidden" name="queryername" value="<?php echo $_SESSION["SESSION_USER"]["name"];?>" />
					...
					<table width="695" border="0" cellpadding="0" cellspacing="1" class="tabThSide">
						...
						<tr>
							<th scope="row">詢價人</th>
							<td colspan="3" id="tdqueryer"><?php echo $_SESSION["SESSION_USER"]["name"];?>
