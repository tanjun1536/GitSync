			...
			<div class="mainInfo">
				...
				<form id="form1" name="form1" method="post" action="">
					<table width="695" border="0" cellpadding="0" cellspacing="0" class="tab_thtop">
						...
						<td align="center"><a href="__URL__/stockStorageView?id=<?php echo ($item["id"]); ?>" ><?php echo ($item["storagecode"]); ?></a></td>
						<td><?php echo ($item["mname"]); ?></td>
						<td align="center"><?php echo (date('Y/m/d',strtotime($item["checkdate"]))); ?></td>
						<td align="center"><?php echo ($item["totalmoney"]); ?></td>
						<td align="center"><?php echo ($item["state"]); ?></td>
						<td align="center">
						<?php if($item["state"] == '新進單' ): ?><a href="__URL__/stockStorageCheckPage?id=<?php echo ($item["id"]); ?>">審核</a>
						<?php elseif($item["state"] == '核可'): ?>
						<a href="__URL__/stockStorageBackPage?id=<?php echo ($item["id"]); ?>">退貨</a>
						<?php else: ?><?php endif; ?>
						</td>
