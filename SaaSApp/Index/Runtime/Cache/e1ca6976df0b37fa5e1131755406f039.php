...
<?php if(is_array($TopMenu)): $i = 0; $__LIST__ = $TopMenu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): ++$i;$mod = ($i % 2 )?><?php if(empty($item["children"])): ?><li><a href="<?php echo ($item["link"]); ?>"><?php echo ($item["name"]); ?></a></li>
		...
		<li><a href="__APP__/Favorite">我的最愛</a>  </li>
			...
			<div class="mainInfo">
				<div class="topic2">進貨單</div>
				<table width="695" border="0" cellpadding="0" cellspacing="1" class="tabThSide">
					<tr>
						<th width="92" scope="row">驗貨單編號</th>
						<td width="241"><?php echo ($sc["checkcode"]); ?></td>
						<th width="84" scope="row">採購對象</th>
						<td width="273"><?php echo ($sc["mname"]); ?></td>
					</tr>
					<tr>
						<th scope="row">進貨單編號</th>
						<td><?php echo ($sc["storagecode"]); ?></td>
						<th scope="row">進貨日期</th>
						<td><?php echo (date('Y/m/d',strtotime($sc["checkdate"]))); ?></td>
					</tr>
					<tr>
						<th scope="row">審核者</th>
						<td colspan="3"><?php echo ($sc["audituser"]); ?></td>
					</tr>
					<tr>
						<th scope="row">備註</th>
