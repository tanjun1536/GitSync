...
<body>
	<table width="800" border="0" align="center" cellpadding="0"
		cellspacing="0">
		<tr>
			<td width="231" height="22">和新機電管理股份有限公司</td>
			<td width="284" rowspan="3" align="center"><h1>調 撥 單</h1></td>
			<td width="61">公司電話：</td>
	...
	<table width="800" border="0" align="center" cellpadding="0"
		cellspacing="0">
		<tr>
			<td width="67" height="22">調出倉庫：</td>
			<td width="733"><?php echo ($sc["outwarehousecode"]); ?>- <?php echo ($sc["outwarehousename"]); ?></td>
		</tr>
		<tr>
			<td height="22">調入倉庫：</td>
			<td><?php echo ($sc["inwarehousecode"]); ?>- <?php echo ($sc["inwarehousename"]); ?></td>
		</tr>
	</table>
