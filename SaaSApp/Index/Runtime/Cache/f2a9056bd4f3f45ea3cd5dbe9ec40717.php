		...
		<li><a href="__APP__/Favorite">我的最愛</a>  </li>
			...
			<div class="mainInfo">
				<form id="form1" name="form1" method="post" action="">
					<div class="mailNav">
						<a href="__URL__/workcreate">寫信</a><a href="__URL__/otherwork"> 他人交辦事項 (<strong><?php echo $_SESSION["MSG_OTHER_WORK"];?></strong>)
						</a><a href="__URL__/work" class="select">我交辦事項(<strong><?php echo $_SESSION["MSG_MINE_WORK"];?></strong>)
				...
				<table width="695" border="0" cellpadding="0" cellspacing="0" class="mailList">
					...
					<td><?php echo ($item["receivername"]); ?></td>
					<td><img src="__PUBLIC__/images/bring.gif" alt="" width="18" height="19" /></td>
					<td><a href="__URL__/workview?id=<?php echo ($item["id"]); ?>"><strong><?php echo ($item["title"]); ?><?php if($item["issenderread"] == 0 ): ?>(未讀)<?php else: ?>(已讀)<?php endif; ?></strong></a></td>
