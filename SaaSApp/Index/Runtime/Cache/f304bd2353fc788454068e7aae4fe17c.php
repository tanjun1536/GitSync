...
<?php if(is_array($TopMenu)): $i = 0; $__LIST__ = $TopMenu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): ++$i;$mod = ($i % 2 )?><?php if(empty($item["children"])): ?><li><a href="<?php echo ($item["link"]); ?>"><?php echo ($item["name"]); ?></a></li>
		...
		<li><a href="__APP__/Favorite">我的最愛</a>  </li>
			...
			<div class="mainInfo">
				<form action="__URL__/addProductMainType" method="post" enctype="multipart/form-data" name="form1" id="form1">
					<input type="hidden" name="id" style="width: 400px" value="<?php echo ($mt["id"]); ?>" /> <input type="hidden" name="code" style="width: 400px" value="<?php echo $_SESSION["SESSION_USER"]["code"];?>" />
					<div class="topic2">商品主類別</div>
<!-- 					<table width="695" border="0" align="center" cellpadding="0" cellspacing="1" class="tabThSide"> -->
<!-- 						<tr> -->
<!-- 							<th width="134" scope="row">新增 / 修改主類別</th> -->
<!-- 							<td width="558"> -->
<!-- 							<select name="btype" id="btype"> -->
<!-- 							<option value="">請選擇大類別</option> -->
<!-- 									<?php if(is_array($btypes)): $i = 0; $__LIST__ = $btypes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): ++$i;$mod = ($i % 2 )?>-->
<!-- 									<option value="<?php echo ($item["id"]); ?>"><?php echo ($item["name"]); ?></option> -->
<!--<?php endforeach; endif; else: echo "" ;endif; ?> -->
<!-- 							</select><input type="text" name="name" value="<?php echo ($mt["name"]); ?>" /> <input type="submit" name="Submit" value="確定" /></td> -->
<!-- 						</tr> -->
<!-- 					</table> -->
				</form>
				<form id="form2" name="form2" method="post" action="">
					...
					<table width="695" border="0" cellpadding="0" cellspacing="0" class="tab_thtop">
						<tr>
							...
							<th width="346" scope="col">主類別</th>
							<th width="347" scope="col">操作</th>
						</tr>
						...
						<td align="center"><?php echo ($item["cname"]); ?></td>
						<td align="center"><a href="__URL__/productChildType?bt=<?php echo ($item["bid"]); ?>&mt=<?php echo ($item["id"]); ?>"><?php echo ($item["s_name"]); ?></a></td>
						<td align="center"><a href="__URL__/updateProductMainType?id=<?php echo ($item["id"]); ?>">修改</a> | <a onclick="return confirm('是否刪除該數據?')" href="__URL__/deleteProductMainType?id=<?php echo ($item["id"]); ?>">刪除</a></td>
