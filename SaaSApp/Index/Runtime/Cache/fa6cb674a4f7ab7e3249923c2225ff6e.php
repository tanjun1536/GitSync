...
<script type="text/javascript">
	function query() {
		$("#form1").attr("action", "__URL__/index").submit();
	}
	function exportExcel() {
		$("#form1").attr("action", "__URL__/exportExcel").submit();
	}
</script>
		...
		<li><a href="__APP__/Favorite">我的最愛</a>  </li>
			...
			<div class="mainInfo">
				<form id="form1" name="form1" method="post" action="">
					<div class="mailNav">
						<a href="__URL__/addCustomer">新增客戶</a>客戶名稱 <input type="text"
							name="scn" /> 行業別 <select name="hyb">
						...
						</select> <input type="button" name="Submit" value="搜尋" onclick="query()" />
						<input type="button" name="Submit" value="匯出"
							onclick="exportExcel()" />
					</div>
				</form>
				<table width="695" border="0" cellpadding="0" cellspacing="0"
					class="tab_thtop">
					<tr>
						<th width="124" scope="col">客戶編號</th>
						<th width="247" scope="col">客戶名稱</th>
						<th width="100" scope="col">聯絡人</th>
						<th width="120" scope="col">電話</th>
						<th width="102" scope="col">操作</th>
					</tr>
					...
					<td align="center"><?php echo ($item["clientcode"]); ?></td>
					<td><a href="__URL__/viewCustomer?id=<?php echo ($item["id"]); ?>"><?php echo ($item["companyname"]); ?></a></td>
					<td align="center"><?php echo ($item["linkername1"]); ?></td>
					<td align="center"><?php echo ($item["linkerphone1"]); ?></td>
					<td align="center"><a
						href="__URL__/editCustomer?id=<?php echo ($item["id"]); ?>">修改</a> | <a
						onclick="return confirm('是否刪除選擇的數據?')"
						href="__URL__/deleteCustomer?id=<?php echo ($item["id"]); ?>">刪除</a></td>
